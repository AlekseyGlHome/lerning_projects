...
public class DBConnection {
            ...
            try {
                connection = DriverManager.getConnection(
                        "jdbc:mysql://localhost:3306/" + dbName +
                                "?user=" + dbUser + "&password=" + dbPass+"&rewriteBatchedStatements=true");
    ...
    public static void insertMultilineQuery(StringBuilder builder) throws SQLException {
        Connection con =  DBConnection.getConnection();
        con.setAutoCommit(false);
        con.createStatement()
                .execute("INSERT INTO voter_count(name, birthDate) VALUES"+builder.toString());//+
    ...
    public static void printVoterCounts() throws SQLException {
        //String sql = "SELECT * from learn.voter_count where count>1 ";
